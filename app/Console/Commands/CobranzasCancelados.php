...
use DB;
use Log;
class CobranzasCancelados extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'prestamos:CobranzasCancelados';
     ...
     * @var string
     */
    protected $description = 'Paso 2:consiliador cancelados XD';
    ...
    public function handle()
    {
        ...
        $path = storage_path('excel/export/Prestamos Exactos c1.xls');
        ...
        Excel::create('Prestamos Cancelados c2',function($excel)
        {
            global $rows_exacta,$rows_not_found,$rows_dos_exacto,$rows_verificar,$nro_comprobante,$prestamos_noreg,$rows_gar;
