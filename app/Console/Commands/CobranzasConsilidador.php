...
class CobranzasConsilidador extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'prestamos:Cobranzas';
     ...
     * @var string
     */
    protected $description = 'Paso 1 Prestmos Exactos';
    ...
    public function handle()
    {
        ...
        Excel::create('Prestamos Exactos c1',function($excel)
        {
            global $rows_exacta,$rows_not_found,$rows_dos_exacto,$rows_verificar,$nro_comprobante,$prestamos_noreg,$rows_gar;
