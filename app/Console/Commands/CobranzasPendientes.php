...
use DB;
use Log;
class CobranzasPendientes extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'prestamos:CobranzasPendientes';
     ...
     * @var string
     */
    protected $description = 'Paso 3: Prestamos Refinanciamiento XD';
    ...
    public function handle()
    {
        ...
        $path = storage_path('excel/export/Prestamos Cancelados c2.xls');
        ...
        Excel::create('Prestamos Pendientes c3',function($excel)
        {
            global $rows_exacta,$rows_not_found,$rows_dos_exacto,$rows_verificar,$nro_comprobante,$prestamos_noreg,$rows_gar;
