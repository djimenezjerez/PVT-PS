...
use DB;
use Log;
class DepurarPresGar extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'prestamos:DepurarPresGar';
    ...
    public function handle()
    {
        ...
        $path = storage_path('excel/export/prestamos depurados.xls');
        ...
        Excel::create('presgar depurados',function($excel)
        {
            global $rows_exacta,$rows_not_found,$rows_desc_mayor,$rows_desc_menor,$rows_segundo_prestamo,$rows_indebidos,$rows_gar;
